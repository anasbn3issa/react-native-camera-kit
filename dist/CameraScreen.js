...
export default class CameraScreen extends Component {
    ...
    renderSwitchCameraButton() {
        return (this.props.cameraFlipImage && this.props.cameraFlipImage &&
          ...
          <Image style={{ flex: 1, right: 0, justifyContent: 'flex-end' }} source={this.props.cameraFlipImage} resizeMode="contain"/>
        </TouchableOpacity>));
    }
    renderTopButtons() {
    ...
    renderBottomButtons() {
        return (!this.props.hideControls && (<SafeAreaView style={[styles.bottomButtons, { backgroundColor: '#ffffff00' }]}>
          ...
          {this.state.captureImages && this.state.captureImages.length > 0  ? this.renderBottomButton('right') : <View style={styles.captureButtonContainer}></View>}
        </SafeAreaView>));
    }
